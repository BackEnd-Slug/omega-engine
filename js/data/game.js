const game = {
    ...
    achievements: [
        ...
        new Achievement("Tens", "Want to tens?", "10", () => game.layers[0].resource.gte(10)),
        new Achievement("TWENTY", "Want to TWENTY?", "20", () => game.layers[0].resource.gte(20)),
        new Achievement("1/2 HUNDRED", "Want to FIFITY?", "50", () => game.layers[0].resource.gte(50)),
        new Achievement("AWESOME HUNDREDS", "Yes! Hundreds.", "10<sup>2</sup>", () => game.layers[0].resource.gte(100)),
        new Achievement("AWESOME THOUSAND", "Yes! Thousnads.", "10<sup>3</sup>", () => game.layers[0].resource.gte(1000)),
        new Achievement("AWESOME TEN THOUSAND", "Yes! TEN Thousnads.", "10<sup>4</sup>", () => game.layers[0].resource.gte(10000)),
        new Achievement("AWESOME HUNDRED THOUSAND", "Yes! HUNDRED Thousnads.", "10<sup>5</sup>", () => game.layers[0].resource.gte(100000)),
        new Achievement("AWESOME MILLION", "Yes! MILLIONS.", "10<sup>6</sup>", () => game.layers[0].resource.gte("1e6")),
        new Achievement("AWESOME BILLION", "Yes! BILLION.", "10<sup>9</sup>", () => game.layers[0].resource.gte("1e9")),
        new Achievement("WHAT", "TEN BILLION TAT.", "10<sup>10</sup>", () => game.layers[0].resource.gte("1e10")),
        new Achievement("Trillion", "First Trillion.", "10<sup>12</sup>", () => game.layers[0].resource.gte("1e12")),
