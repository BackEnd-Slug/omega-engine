const game = {
    ...
    achievements: [
        ...
        new Achievement("AWESOME THOUSAND", "Yes! Thousnads.", "10<sup>3</sup>", () => game.layers[0].resource.gt(1000)),
        new Achievement("AWESOME TEN THOUSAND", "Yes! TEN Thousnads.", "10<sup>4</sup>", () => game.layers[0].resource.gt(10000)),
        new Achievement("AWESOME HUNDRED THOUSAND", "Yes! HUNDRED Thousnads.", "10<sup>5</sup>", () => game.layers[0].resource.gt(100000)),
